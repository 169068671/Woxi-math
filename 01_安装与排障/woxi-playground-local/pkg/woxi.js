 ...
 */
export function set_virtual_file(name, data) {
 ...
 */
export function clear_virtual_files() {
 ...
 * @returns {string}
 */
export function take_exported_files() {
    let deferred1_0;
    let deferred1_1;
    try {
        const ret = wasm.take_exported_files();
        deferred1_0 = ret[0];
        deferred1_1 = ret[1];
 ...
 * @returns {string}
 */
export function split_statements(input) {
    let deferred2_0;
    let deferred2_1;
    try {
 ...
 * @returns {string}
 */
export function evaluate_statement(stmt) {
    let deferred2_0;
    let deferred2_1;
    try {
 ...
 * @returns {string}
 */
export function evaluate_manipulate(body, bindings_json) {
    let deferred3_0;
    let deferred3_1;
    try {
 ...
 * @returns {string}
 */
export function evaluate_manipulate_enabled(conditions_json, bindings_json) {
    let deferred3_0;
    let deferred3_1;
    try {
 ...
 * @returns {string}
 */
export function evaluate_manipulate_full(body, displays_json, bindings_json, mutations_json) {
    let deferred5_0;
    let deferred5_1;
    try {
        const ptr0 = passStringToWasm0(body, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
 ...
 * @returns {string}
 */
export function evaluate_expr(input) {
    let deferred2_0;
    let deferred2_1;
    try {
        const ptr0 = passStringToWasm0(input, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
 ...
 */
export function set_dark_mode(enabled) {
 ...
 * @returns {string}
 */
export function evaluate_all(input) {
    let deferred2_0;
    let deferred2_1;
    try {
        const ptr0 = passStringToWasm0(input, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
...
function __wbg_get_imports() {
    ...
    imports.wbg.__wbg___woxi_fetch_url_1a2edada61209f50 = function() { return handleError(function (arg0, arg1, arg2) {
    ...
    imports.wbg.__wbg___woxi_report_panic_295788df1c67306c = function() { return handleError(function (arg0, arg1) {
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('woxi_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
